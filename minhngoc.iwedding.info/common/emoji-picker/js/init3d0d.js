import '/minhngoc.iwedding.info/common/emoji-picker/js/index.js'
$(".textarea-emoji-picker emoji-picker").dataSource = '/minhngoc.iwedding.info/common/emoji-picker/js/data.json';
